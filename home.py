...
def func4():
    ...
    sbmibtn = Button(screen4, text='Godowns',command=create17,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=650, y=440)
...
def func12():
    ...
    screen10.geometry('800x400')
    Label(screen10, text='List of Godowns',bg="lightblue",font='15',fg="BLACK",width=640).pack() 
    frame10 = Frame(screen4, bg="lightblue", width=180, height=790)
    frame10.place(x=1400, y=0)
    sbmibtn1 = Button(screen10, text='Name :',fg='black',font=('Arial',9),activebackground='palegreen',width=35,border=0).place(x=20, y=30)
    sbmibtn2 = Button(screen10, text='(Alias)',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=20, y=60)
    sbmibtn3 = Button(screen10, text='Under    : primary ',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=20, y=100)
    sbmibtn4 = Button(screen10, text='Nature of Group',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=20, y=140)
    sbmibtn5 = Button(screen10, text='Group behaves like a sub-ledger   :',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=10, y=180)
    sbmibtn6 = Button(screen10, text='Nett Debit/Credit Balances For Reporting :',fg='black',font=('Arial',9),activebackground='palegreen',width=40,border=0).place(x=20, y=200)
    sbmibtn7 = Button(screen10, text='Used for calculation( for example: taxes, discounts)  :',fg='black',font=('Arial',9),activebackground='palegreen',width=40,border=0).place(x=20, y=220)
    sbmibtn8 = Button(screen10, text='(for sales invoice entries)',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=20, y=240)
    sbmibtn9 = Button(screen10, text='Method to allocate when used in purchase invoice  :',fg='black',font=('Arial',9),activebackground='palegreen',width=40,border=0).place(x=20, y=260)
    e12 = Entry(screen10,).place(x=170, y=30)  
...
def create9():
    ...
    sbmibtn14 = Button(screen4, text='Current Assets',fg='black',font=('Arial',9),command=func40,activebackground='palegreen',width=30,border=0).place(x=12, y=80)
    sbmibtn15 = Button(screen4, text='Bank Accounts',fg='black',font=('Arial',9),command=func41,activebackground='palegreen',width=30,border=0).place(x=39, y=100)
    sbmibtn16 = Button(screen4, text='Current Assets',fg='black',font=('Arial',9),command=func42,activebackground='palegreen',width=30,border=0).place(x=12, y=120)
    sbmibtn16 = Button(screen4, text='Cash in Hand',fg='black',font=('Arial',9),command=func43,activebackground='palegreen',width=30,border=0).place(x=25, y=140)
    sbmibtn16 = Button(screen4, text='Cash',fg='black',font=('Arial',9),command=func44,activebackground='palegreen',width=30,border=0).place(x=20, y=160)
    sbmibtn16 = Button(screen4, text='Deposits(Assets)',fg='black',font=('Arial',9),command=func45,activebackground='palegreen',width=30,border=0).place(x=30, y=160)
    sbmibtn16 = Button(screen4, text='Loans & Advances(Assets)',fg='black',font=('Arial',9),command=func46,activebackground='palegreen',width=30,border=0).place(x=55, y=180)
    sbmibtn16 = Button(screen4, text='Stock In Hand',fg='black',font=('Arial',9),command=func47,activebackground='palegreen',width=30,border=0).place(x=15, y=200)
    sbmibtn16 = Button(screen4, text='Sundry Debtors',fg='black',font=('Arial',9),command=func48,activebackground='palegreen',width=30,border=0).place(x=20, y=220)
    sbmibtn16 = Button(screen4, text='Fixed Assets',fg='black',font=('Arial',9),command=func49,activebackground='palegreen',width=30,border=0).place(x=20, y=240)
    sbmibtn16 = Button(screen4, text='Investments',fg='black',font=('Arial',9),command=func50,activebackground='palegreen',width=30,border=0).place(x=20, y=260)
    sbmibtn16 = Button(screen4, text='Misc.Expenses (ASSETS)',fg='black',font=('Arial',9),command=func51,activebackground='palegreen',width=30,border=0).place(x=20, y=280)
    ...
    sbmibtn13 = Button(screen4, text='Branch / Divisions',fg='black',font=('Arial',9),command=func52,activebackground='palegreen',width=30,border=0).place(x=20, y=340)
    sbmibtn14 = Button(screen4, text='Capital Account',fg='black',font=('Arial',9),command=func53,activebackground='palegreen',width=30,border=0).place(x=12, y=360)
    sbmibtn15 = Button(screen4, text='Reserve and Surplus',fg='black',font=('Arial',9),command=func54,activebackground='palegreen',width=30,border=0).place(x=39, y=380)
    sbmibtn16 = Button(screen4, text='Current Liabalities',fg='black',font=('Arial',9),command=func55,activebackground='palegreen',width=30,border=0).place(x=20, y=400)
    sbmibtn16 = Button(screen4, text='Duties & taxes',fg='black',font=('Arial',9),command=func56,activebackground='palegreen',width=30,border=0).place(x=20, y=420)
    sbmibtn16 = Button(screen4, text='Provisions',fg='black',font=('Arial',9),command=func57,activebackground='palegreen',width=30,border=0).place(x=20, y=440)
    sbmibtn16 = Button(screen4, text='Sundry creditors',fg='black',font=('Arial',9),command=func58,activebackground='palegreen',width=30,border=0).place(x=20, y=460)
    sbmibtn16 = Button(screen4, text='Loans(liability)',fg='black',font=('Arial',9),command=func59,activebackground='palegreen',width=30,border=0).place(x=20, y=480)
    sbmibtn16 = Button(screen4, text='Bank OD A/c',fg='black',font=('Arial',9),command=func60,activebackground='palegreen',width=30,border=0).place(x=20, y=500)
    sbmibtn16 = Button(screen4, text='Secured Loans',fg='black',font=('Arial',9),command=func61,activebackground='palegreen',width=30,border=0).place(x=20, y=520)
    sbmibtn16 = Button(screen4, text='Unsecured Loans',fg='black',font=('Arial',9),command=func62,activebackground='palegreen',width=30,border=0).place(x=20, y=540)
    sbmibtn16 = Button(screen4, text='Sales Accounts',fg='black',font=('Arial',9),command=func63,activebackground='palegreen',width=30,border=0).place(x=20, y=560)
    ...
    sbmibtn16 = Button(screen4, text='Direct Expenses ',fg='black',font=('Arial',9),command=func64,activebackground='palegreen',width=30,border=0).place(x=20, y=640)
    sbmibtn16 = Button(screen4, text='Indirect Expenses ',fg='black',font=('Arial',9),command=func65,activebackground='palegreen',width=30,border=0).place(x=20, y=660)
    sbmibtn16 = Button(screen4, text='Purchase Accounts ',fg='black',font=('Arial',9),command=func66,activebackground='palegreen',width=30,border=0).place(x=20, y=680)
    
    
    sbmibtn16 = Button(screen4, text='Income  ',fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=20, y=720)
    sbmibtn16 = Button(screen4, text='Direct Income  ',fg='black',font=('Arial',9),command=func67,activebackground='palegreen',width=30,border=0).place(x=20, y=740)
    frame10 = Frame(screen4, bg="lightblue", width=180, height=790)
    frame10.place(x=1400, y=0)
    date = Button(frame10, text="Date", width=14, fg="black", font=(
    "timesnewroman",9), activebackground="palegreen", activeforeground="red")
...
def create10():
    ...
    sbmibtn16 = Button(screen4, text='Contra ',fg='black',font=('Arial',9),command=func68,activebackground='palegreen',width=30,border=0).place(x=20, y=100)
    sbmibtn16 = Button(screen4, text='Credit Note',fg='black',font=('Arial',9),command=func69,activebackground='palegreen',width=30,border=0).place(x=20, y=120)
    sbmibtn16 = Button(screen4, text='Debit Note ',fg='black',font=('Arial',9),command=func70,activebackground='palegreen',width=30,border=0).place(x=20, y=140)
    sbmibtn16 = Button(screen4, text='Delivery Note ',fg='black',font=('Arial',9),command=func71,activebackground='palegreen',width=30,border=0).place(x=20, y=160)
    ...
    sbmibtn16 = Button(screen4, text='Journel',fg='black',font=('Arial',9),command=func72,activebackground='palegreen',width=30,border=0).place(x=20, y=220)
    sbmibtn16 = Button(screen4, text='Material In',fg='black',font=('Arial',9),command=func73,activebackground='palegreen',width=30,border=0).place(x=20, y=240)
    sbmibtn16 = Button(screen4, text='Material Out',fg='black',font=('Arial',9),command=func74,activebackground='palegreen',width=30,border=0).place(x=20, y=260)
    sbmibtn16 = Button(screen4, text='Memorandum',fg='black',font=('Arial',9),command=func75,activebackground='palegreen',width=30,border=0).place(x=20, y=280)
    sbmibtn16 = Button(screen4, text='Payment',fg='black',font=('Arial',9),command=func76,activebackground='palegreen',width=30,border=0).place(x=20, y=300)
    sbmibtn16 = Button(screen4, text='Payrol',fg='black',font=('Arial',9),command=func77,activebackground='palegreen',width=30,border=0).place(x=20, y=320)
    sbmibtn16 = Button(screen4, text='Physical Stock',fg='black',font=('Arial',9),command=func78,activebackground='palegreen',width=30,border=0).place(x=20, y=340)
    sbmibtn16 = Button(screen4, text='Purchase',fg='black',font=('Arial',9),command=func79,activebackground='palegreen',width=30,border=0).place(x=20, y=360)
    sbmibtn16 = Button(screen4, text='Purchase Order',fg='black',font=('Arial',9),command=func80,activebackground='palegreen',width=30,border=0).place(x=20, y=380)
    sbmibtn16 = Button(screen4, text='Reciept',fg='black',font=('Arial',9),command=func81,activebackground='palegreen',width=30,border=0).place(x=20, y=400)
    sbmibtn16 = Button(screen4, text='Reciept Note',fg='black',font=('Arial',9),command=func82,activebackground='palegreen',width=30,border=0).place(x=20, y=420)
    sbmibtn16 = Button(screen4, text='Rejections In',fg='black',font=('Arial',9),command=func83,activebackground='palegreen',width=30,border=0).place(x=20, y=440)
    sbmibtn16 = Button(screen4, text='Rejections Out',fg='black',font=('Arial',9),command=func84,activebackground='palegreen',width=30,border=0).place(x=20, y=460)
    sbmibtn16 = Button(screen4, text='Reversing Journel',fg='black',font=('Arial',9),command=func85,activebackground='palegreen',width=30,border=0).place(x=20, y=480)
    sbmibtn16 = Button(screen4, text='Sales',fg='black',font=('Arial',9),command=func86,activebackground='palegreen',width=30,border=0).place(x=20, y=500)
    sbmibtn16 = Button(screen4, text='Sales Order',fg='black',font=('Arial',9),command=func87,activebackground='palegreen',width=30,border=0).place(x=20, y=520)
    sbmibtn16 = Button(screen4, text='Stock Journel',fg='black',font=('Arial',9),command=func88,activebackground='palegreen',width=30,border=0).place(x=20, y=540)
    frame10 = Frame(screen4, bg="lightblue", width=180, height=790)
    frame10.place(x=1400, y=0)
    date = Button(frame10, text="Date", width=14, fg="black", font=(
    "timesnewroman",9), activebackground="palegreen", activeforeground="red")
